...
var btn3 = document.getElementById('export');
...
date.oninput = async(e)=>{
    if(e.currentTarget.value != ''){
        fname = new Date(date.value).toDateString();
...
var tableToExcel = (function() {
  ...
  return function(table, name) {
    ...
    let tdth = document.querySelectorAll('TD ,TH')
